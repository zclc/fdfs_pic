    ...
    ui(new Ui::Login)
{
    ...
    // 窗口图标
    this->setWindowIcon(QIcon(":/MyImage/icons8-cloud-100.png"));
    m_mainWin->setWindowIcon(QIcon(":/MyImage/icons8-cloud-100.png"));
    // 去掉边框
...
void Login::paintEvent(QPaintEvent *)
{
    ...
    QPixmap pixmap(":/MyImage/coolHue-C2FFD8-465EFB.png");
